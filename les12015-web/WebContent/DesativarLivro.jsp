...
<html>
	<head>
		...
		<title>Desativar Livro - XINGLING</title>
	</head>
	<body>
		<c:import url="CabecalhoAdmin.jsp"/>
		
		<div class="panel panel-primary campos-cadastro-livro">
			<div class="panel-heading panel-primary">Inativar Livro</div>
		...
		<form>
			<div class="panel-body">
				...
				<button type="submit" class="btn btn-danger btn-md btn-confirmar" > 
		...
		<div class="panel panel-primary campos-cadastro-livro panel-ati-inativacao">
			<div class="panel-heading panel-default">Inativar Livro</div>
			<div class="panel-body">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="form-group">
								<button type="submit" class="btn btn-danger btn-md" > Confirmar Inativação</button>
						</div>
					</div>
				</div>
