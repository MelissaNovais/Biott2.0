			...
			<div class="panel-body">
				...
				<form action="GerenciarEstoque" method="GET">
					<div class="row">
						...
						<div class="col-md-3">
							<div class="form-group">
								<input id="txtIdFornecedor" class="form-control" type="text" placeholder="Id Fornecedor">
							</div>
						</div>
	
						<div class="col-md-3">
							<div class="form-group">
								<input id="txtQtdeEstoque" class="form-control" type="text" placeholder="Quantidade">
							</div>
						</div>
						
						<div class="col-md-3">
							<div class="form-group">
								<input id="txtCusto" class="form-control" type="text" placeholder="Custo R$ (Uni)">
							</div>
						</div>
					</div>
